# Drone detection model provide the trained model file (pt format) and process file.

# Body

Drone Detection Model, provide the trained model file (pt format) and process file, with a dataset of 8900 images, clear pictures, complete annotations, suitable for drone target detection, project experiments, learning research and other scenarios. Just take it directly after receiving it, worry-free
